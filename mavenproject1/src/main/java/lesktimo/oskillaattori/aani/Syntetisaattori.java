...
public class Syntetisaattori {
    ...
    /**
     * Saa arvokseen lukijan lukemat nuotit ja soittaa ne käyttäen
     * allokaattoria.
     *
     * @param nuotinNumero Halutun nuotin relatiivinen numero, jotta tiedetään
     * mikä nuotti soitetaan.
     * @param pituus Kauanko nuottia tulee soittaa.
     * @param paalla Halutaanko soittaa vai lopettaa soitto.
     * @throws InterruptedException Heittää virhesanoman mikäli juoksu keskeytyy
     * yllättäen.
     */
